...
## Introduction
InternTrack.Web is a Standard-Compliant .NET portal built on top of InternTrack.Core API RESTful endpoints to enable software engineers to develop Intern tracking solutions in .NET.
